<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" type="number" placeholder="12201"
            ...
            <x-inputs.text-area id="company_description" name="company_description" label="Company Description"
                rows="3" placeholder="Company Description" :value="old('company_description', $job->description)" />

            <x-inputs.text id="company_website" name="company_website" label="Company Website"
                placeholder="Company Website" type="url" :value="old('company_website', $job->company_website)" />
